...
const dummyData = [
  ...
  { id: 5, description: "Pertrol", amount: -250},
];

let transactions = dummyData
*/

const localStorgeTrans=JSON.parse(localStorage.getItem("trans"));
let transactions = localStorage.getItem("trans")!==null?localStorgeTrans:[];
